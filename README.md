...
Theres also a 24 Bit controller project to go along with this mod to maximize your versitility
The 24 bit controller will allow for full calibration WITHOUT external software!
This provides consistent calibration and accuracy across all games, and much more!
Mulitple versions of the controller will be released for easy to advanced skill levels

Full Build on Imgur here;

https://imgur.com/gallery/pneumatic-mod-sim-jack-simsonn-pedals-RCznx2G

* This project is a work in progress so proceed with that in mind. 
